            ...
            <div className="text-center space-y-8 md:space-y-12">
              <div className="relative inline-block">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Sun size={window.innerWidth < 640 ? 70 : window.innerWidth < 768 ? 90 : 120} weight="fill" className="text-primary drop-shadow-[0_0_20px_oklch(0.75_0.20_45)] md:drop-shadow-[0_0_30px_oklch(0.75_0.20_45)]" />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 text-left max-w-4xl mx-auto">
                <div className="glass-card p-5 md:p-8 group hover:scale-105 transition-transform duration-300">
                  <Lightning size={window.innerWidth < 640 ? 36 : 48} weight="fill" className="text-primary mb-3 md:mb-4 drop-shadow-[0_0_10px_oklch(0.75_0.20_45)] md:drop-shadow-[0_0_15px_oklch(0.75_0.20_45)] group-hover:animate-glow" />
                ...
                <div className="glass-card p-5 md:p-8 group hover:scale-105 transition-transform duration-300">
                  <CurrencyCircleDollar size={window.innerWidth < 640 ? 36 : 48} weight="fill" className="text-accent mb-3 md:mb-4 drop-shadow-[0_0_10px_oklch(0.78_0.19_42)] md:drop-shadow-[0_0_15px_oklch(0.78_0.19_42)] group-hover:animate-glow" />
                ...
                <div className="glass-card p-5 md:p-8 group hover:scale-105 transition-transform duration-300 sm:col-span-2 md:col-span-1">
                  <ChartLine size={window.innerWidth < 640 ? 36 : 48} weight="fill" className="text-secondary mb-3 md:mb-4 drop-shadow-[0_0_10px_oklch(0.70_0.18_40)] md:drop-shadow-[0_0_15px_oklch(0.70_0.18_40)] group-hover:animate-glow" />
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="relative">
                ...
                <div className="relative p-1.5 sm:p-2 bg-primary/10 rounded-lg border border-primary/30">
                  <Sun size={28} weight="fill" className="text-primary sm:w-8 sm:h-8 drop-shadow-[0_0_10px_oklch(0.75_0.20_45)]" />
                </div>
              </div>
              <div>
